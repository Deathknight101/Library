        ...
        <div>
           ...
           ">
                ...
                <div className="flex-1 h-full">
                    <h1 className="lg:text-start text-center lg:text-9xl text-6xl text mb-9">Our Dream is Knowledge Without Bounds</h1>
                ...
                <div className="flex-1 flex flex-col gap-5">
                    <div className="">
                        <img className="rounded-lg" src="/images/pexels.jpg" alt="" />
                    </div>
